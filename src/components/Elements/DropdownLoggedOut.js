...
export default function DropdownLoggedOut({ setDropDown, dropdownRef }) {
    return (
        <div ref={dropdownRef} id="dropdownAvatar" className="select-none absolute top-10 right-0 w-36 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
