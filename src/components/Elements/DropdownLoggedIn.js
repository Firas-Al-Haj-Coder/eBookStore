...
export default function DropdownLoggedIn({ setDropDown, dropdownRef }) {
    ...
    // NOW that we have our API exported in dataService we can just call it and get the current loggedin User to show his email address
    ...
    return (
        <div ref={dropdownRef} id="dropdownAvatar" className="select-none	absolute top-10 right-0 z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
            <div className="py-3 px-4 text-sm text-gray-900 dark:text-white">
                <div className="font-medium truncate">{userInfo && userInfo.email }</div>
            </div>
