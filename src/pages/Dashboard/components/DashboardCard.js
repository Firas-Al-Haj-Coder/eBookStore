...
export default function DashboardCard( { order }) {

    // console.log(order); // individuelle Order mit n products in der productsCartList
    return (
        ...
        {/* Each OrderCard will have it's orderedproductsList in it - I called it productsCartList */}
        { order.productsCartList.map( (product) => (
